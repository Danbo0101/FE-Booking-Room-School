...
const TableKey = (props) => {
    ...
    const { listKeyOfClass, LIMIT_DEVICE, currentPage } = props;
    ...
    }, [currentPage, listKeyOfClass])

    const CalPageCount = () => {

        const totalListKey = listKeyOfClass.length;
    ...
    const fetchListWithPaginate = () => {
        ...
        const paginatedList = listKeyOfClass.slice(startIndex, endIndex);
